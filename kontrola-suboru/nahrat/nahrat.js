...
// vetu „pošlite súbor na podpora@arling.sk". Za 149 € to vyzeralo ako
...
(function () {
  ...
  var TEXTY = {
    sk: {
      bezSession: 'Na túto stránku sa dá dostať len z platby. Otvorte prosím odkaz, ktorý vám ukázal Stripe po zaplatení, alebo nám napíšte na podpora@arling.sk a pošleme vám ho znova.',
      ...
      neznama: 'Túto objednávku nepoznáme. Skontrolujte prosím, či ste otvorili odkaz od Stripu celý, alebo nám napíšte na podpora@arling.sk.',
      ...
      velky: 'Tento súbor má viac ako 5 MB. Napíšte nám prosím na podpora@arling.sk a dohodneme sa na inom spôsobe.',
      ...
      chyba: 'Nahranie sa nepodarilo. Skúste to prosím znova, alebo nám súbor pošlite na podpora@arling.sk.',
      ...
      dodaniePozn: 'O prijatí súboru rozhoduje vaša banka. Ak niečo nesedí, napíšte na podpora@arling.sk.',
    },
    de: {
      bezSession: 'Diese Seite ist nur über die Zahlung erreichbar. Öffnen Sie bitte den Link, den Ihnen Stripe nach der Zahlung gezeigt hat, oder schreiben Sie an support@arling.sk, dann senden wir ihn erneut.',
      ...
      neznama: 'Diese Bestellung kennen wir nicht. Prüfen Sie bitte, ob Sie den Link von Stripe vollständig geöffnet haben, oder schreiben Sie an support@arling.sk.',
      ...
      vybrane: function (n, kb) { return n + ', ' + kb + ' kB'; },
      velky: 'Diese Datei ist größer als 5 MB. Schreiben Sie uns bitte an support@arling.sk, dann finden wir einen anderen Weg.',
      ...
      chyba: 'Der Upload hat nicht funktioniert. Versuchen Sie es bitte erneut oder senden Sie uns die Datei an support@arling.sk.',
      ...
      dodaniePozn: 'Ob die Datei angenommen wird, entscheidet Ihre Bank. Wenn etwas nicht passt, schreiben Sie an support@arling.sk.',
    },
    en: {
      bezSession: 'This page can only be reached from the payment. Please open the link Stripe showed you after paying, or write to support@arling.sk and we will send it again.',
      ...
      neznama: 'We do not know this order. Please check that you opened the whole link from Stripe, or write to support@arling.sk.',
      ...
      vybrane: function (n, kb) { return n + ', ' + kb + ' kB'; },
      velky: 'This file is larger than 5 MB. Please write to support@arling.sk and we will find another way.',
      ...
      chyba: 'The upload did not work. Please try again, or send us the file at support@arling.sk.',
      ...
      dodaniePozn: 'Whether the file is accepted is decided by your bank. If something does not add up, write to support@arling.sk.',
    },
  };
