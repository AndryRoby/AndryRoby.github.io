...
(function () {
  ...
  var T = {
    sk: {
      ...
      limit: 'Z tejto adresy prišlo veľa pokusov za krátky čas. Skúste to o hodinu, alebo pošlite vzor z časti 3 e-mailom na andrej@arling.sk.',
      pretazene: 'Funkcia je teraz preťažená a nič sme neprijali. Pošlite prosím vzor z časti 3 e-mailom na andrej@arling.sk, platí rovnako. Neskôr to môžete skúsiť aj tu znova.',
      rychlo: 'Formulár sa odoslal príliš rýchlo. Počkajte pár sekúnd a potvrďte ešte raz.',
      chyba: 'Odstúpenie sa nepodarilo odoslať a nič sme neprijali. Skúste to znova o chvíľu, alebo pošlite vzor z časti 3 e-mailom na andrej@arling.sk.',
    ...
    en: {
      ...
      limit: 'Too many attempts from this address in a short time. Please try again in an hour, or e-mail the model form from section 3 to andrej@arling.sk.',
      pretazene: 'The function is overloaded right now and we have received nothing. Please e-mail the model form from section 3 to andrej@arling.sk; it counts just the same. You can also try here again later.',
      rychlo: 'The form was sent too quickly. Please wait a few seconds and confirm again.',
      chyba: 'The withdrawal could not be sent and we have received nothing. Please try again shortly, or e-mail the model form from section 3 to andrej@arling.sk.',
    ...
    de: {
      ...
      limit: 'Zu viele Versuche von dieser Adresse in kurzer Zeit. Bitte versuchen Sie es in einer Stunde erneut oder senden Sie das Muster aus Abschnitt 3 per E-Mail an andrej@arling.sk.',
      pretazene: 'Die Funktion ist gerade überlastet, bei uns ist nichts eingegangen. Bitte senden Sie das Muster aus Abschnitt 3 per E-Mail an andrej@arling.sk, das gilt genauso. Später können Sie es auch hier erneut versuchen.',
      rychlo: 'Das Formular wurde zu schnell gesendet. Bitte warten Sie einige Sekunden und bestätigen Sie erneut.',
      chyba: 'Der Widerruf konnte nicht gesendet werden, bei uns ist nichts eingegangen. Bitte versuchen Sie es gleich noch einmal oder senden Sie das Muster aus Abschnitt 3 per E-Mail an andrej@arling.sk.',
