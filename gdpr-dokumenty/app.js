...
const T = {
  sk: {
    ...
    zapina: 'Platba sa práve zapína. Skúste to o chvíľu alebo napíšte na podpora@arling.sk.',
    ...
    nepotvrdene: 'Platbu sa zatiaľ nepodarilo potvrdiť. Skúšame znova; ak ste zaplatili, dokumenty sa odomknú, len čo Stripe odpovie. Ak to trvá dlhšie než pár minút, napíšte na podpora@arling.sk s číslom objednávky z e-mailu od Stripe.',
    ...
    odkazPravda: 'Vyplnené údaje firmy ostávajú len v tomto prehliadači a nikam sa neposielajú. V inom prehliadači sa balík odomkne, ale formulár si vyplníte znova. Od nás vám o tomto nákupe žiadny e-mail nepríde, doklad vám pošle Link.',
    ...
    ucetNedostupne: 'Odosielanie kódov sa ešte zapína, napíšte na podpora@arling.sk.',
    ucetChybaOdoslanie: 'Kód sa nepodarilo odoslať (sieť). Skúste znova alebo napíšte na podpora@arling.sk.',
  ...
  cs: {
    ...
    zapina: 'Platba se právě zapíná. Zkuste to za chvíli nebo napište na podpora@arling.sk.',
    ...
    nepotvrdene: 'Platbu se zatím nepodařilo potvrdit. Zkoušíme znovu; pokud jste zaplatili, dokumenty se odemknou, jakmile Stripe odpoví. Pokud to trvá déle než pár minut, napište na podpora@arling.sk s číslem objednávky z e-mailu od Stripe.',
    ...
    odkazPravda: 'Vyplněné údaje firmy zůstávají jen v tomto prohlížeči a nikam se neodesílají. V jiném prohlížeči se balíček odemkne, ale formulář vyplníte znovu. Od nás vám o tomto nákupu žádný e-mail nepřijde, doklad vám pošle Link.',
    ...
    ucetNedostupne: 'Odesílání kódů se ještě zapíná, napište na podpora@arling.sk.',
    ucetChybaOdoslanie: 'Kód se nepodařilo odeslat (síť). Zkuste to znovu nebo napište na podpora@arling.sk.',
  ...
  de: {
    ...
    zapina: 'Die Zahlung wird gerade aktiviert. Versuchen Sie es gleich noch einmal oder schreiben Sie an support@arling.sk.',
    ...
    nepotvrdene: 'Die Zahlung konnte bisher nicht bestätigt werden. Wir versuchen es erneut; falls Sie bezahlt haben, werden die Dokumente freigeschaltet, sobald Stripe antwortet. Falls das länger als ein paar Minuten dauert, schreiben Sie an support@arling.sk mit der Bestellnummer aus der E-Mail von Stripe.',
    ...
    odkazPravda: 'Die eingegebenen Unternehmensdaten bleiben nur in diesem Browser und werden nirgendwohin gesendet. In einem anderen Browser wird das Paket freigeschaltet, das Formular füllen Sie dort erneut aus. Von uns kommt zu diesem Kauf keine E-Mail, den Beleg schickt Ihnen Link.',
    ...
    ucetNedostupne: 'Der Codeversand wird gerade aktiviert, schreiben Sie an support@arling.sk.',
    ucetChybaOdoslanie: 'Der Code konnte nicht gesendet werden (Netzwerk). Versuchen Sie es erneut oder schreiben Sie an support@arling.sk.',
