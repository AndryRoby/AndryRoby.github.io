...
hraUi({ pravidlo: 'One loop through every swan. White: straight, with a turn next door. Black: a turn, straight on both sides.' });
...
function ukazPasik() {
  ...
  dni.forEach((d, k) => {
    ...
    if (tag === 'a') a.href = adresaDna('/games/swans/', d, dnes);
