...
hraUi({ pravidlo: 'Draw one closed loop along the grid lines. A number says how many of its four sides the loop uses.' });
...
function ukazPasik() {
  ...
  dni.forEach((d, k) => {
    ...
    if (tag === 'a') a.href = adresaDna('/games/otters/', d, dnes);
