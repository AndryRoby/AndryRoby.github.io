...
hraUi({ pravidlo: 'Each number is a run of filled cells in its row or column, in order, with a gap between runs.' });
...
function ukazPasik() {
  ...
  dni.forEach((d, k) => {
    ...
    if (tag === 'a') a.href = adresaDna('/games/magpies/', d, dnes);
