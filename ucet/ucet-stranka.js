...
const T = {
  sk: {
    ...
    nakupyZiadne: 'K tomuto e-mailu zatiaľ nevidíme žiadny nákup. Ak ste platili, môže to chvíľu trvať; inak napíšte na podpora@arling.sk.',
  ...
  en: {
    ...
    nakupyZiadne: 'We do not see any purchase for this e-mail yet. If you just paid, it can take a moment; otherwise write to support@arling.sk.',
  ...
  de: {
    ...
    nakupyZiadne: 'Zu dieser E-Mail-Adresse sehen wir noch keinen Kauf. Wenn Sie gerade bezahlt haben, kann es einen Moment dauern; sonst schreiben Sie an support@arling.sk.',
