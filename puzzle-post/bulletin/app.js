...
const T = {
  ...
  nedoslo: 'If nothing arrives within a few minutes, look in the spam folder and then write to support@arling.sk with the order number from the Stripe e-mail.',
  bezSession: 'If you have just paid, the e-mail with this week’s links is on its way to the address you paid with. Nothing here confirms a payment on its own, so if no e-mail arrives within a few minutes, write to support@arling.sk.',
  ...
  zapina: 'The subscription is still being switched on. Write to support@arling.sk and we will send you this week’s sheet.',
...
const VETA_ODZNAKU = 'All four buttons lead to Stripe test mode. Use the card 4242 4242 4242 4242, any future date and any CVC. No money is taken; the welcome e-mail is sent in test mode too.';
