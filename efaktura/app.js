...
const T = {
  sk: {
    ...
    zapina: 'Platba sa práve zapína. Napíšte na podpora@arling.sk a pošlem vám XML e-mailom.',
    ...
    inaSuma: 'Platba prišla, ale na inú sumu. Napíšte na podpora@arling.sk, vyriešime to ručne.',
    nepotvrdene: 'Platbu sa zatiaľ nepodarilo potvrdiť. Skúšame znova; ak ste zaplatili, sťahovanie sa odomkne, len čo Stripe odpovie. Ak to trvá dlhšie než pár minút, napíšte na podpora@arling.sk s číslom objednávky z e-mailu od Stripe.',
    overZnova: 'Overiť platbu znova',
    siet: 'Overenie platby zlyhalo (sieť). Obnovte stránku; ak to pretrvá, napíšte na podpora@arling.sk.',
    ...
    platnostSkoncila: (d) => 'Platba je overená, ale jej platnosť skončila ' + d + '. Odkaz odomyká sťahovanie len počas zaplatenej doby (24 hodín alebo 30 dní od platby). Na ďalšie XML si kúpte nové odomknutie; ak si myslíte, že ide o chybu, napíšte na podpora@arling.sk s číslom objednávky.',
  ...
  cs: {
    ...
    zapina: 'Platba se právě zapíná. Napište na podpora@arling.sk a pošlu vám XML e-mailem.',
    ...
    inaSuma: 'Platba přišla, ale na jinou částku. Napište na podpora@arling.sk, vyřešíme to ručně.',
    nepotvrdene: 'Platbu se zatím nepodařilo potvrdit. Zkoušíme znovu; pokud jste zaplatili, stahování se odemkne, jakmile Stripe odpoví. Pokud to trvá déle než pár minut, napište na podpora@arling.sk s číslem objednávky z e-mailu od Stripe.',
    overZnova: 'Ověřit platbu znovu',
    siet: 'Ověření platby selhalo (síť). Obnovte stránku; pokud to přetrvává, napište na podpora@arling.sk.',
    ...
    platnostSkoncila: (d) => 'Platba je ověřená, ale její platnost skončila ' + d + '. Odkaz odemyká stahování jen po zaplacenou dobu (24 hodin nebo 30 dní od platby). Na další XML si kupte nové odemčení; pokud jde podle vás o chybu, napište na podpora@arling.sk s číslem objednávky.',
  ...
  de: {
    ...
    zapina: 'Die Zahlung wird gerade aktiviert. Schreiben Sie an support@arling.sk, dann sende ich Ihnen das XML per E-Mail.',
    ...
    inaSuma: 'Die Zahlung ist eingegangen, aber über einen anderen Betrag. Schreiben Sie an support@arling.sk, wir klären das manuell.',
    nepotvrdene: 'Die Zahlung konnte bisher nicht bestätigt werden. Wir versuchen es erneut; falls Sie bezahlt haben, wird der Download freigeschaltet, sobald Stripe antwortet. Falls das länger als ein paar Minuten dauert, schreiben Sie an support@arling.sk mit der Bestellnummer aus der E-Mail von Stripe.',
    overZnova: 'Zahlung erneut prüfen',
    siet: 'Die Prüfung der Zahlung ist fehlgeschlagen (Netzwerk). Laden Sie die Seite neu; falls das anhält, schreiben Sie an support@arling.sk.',
    ...
    platnostSkoncila: (d) => 'Die Zahlung ist bestätigt, ihr Zeitraum endete aber am ' + d + '. Der Link schaltet den Download nur für den bezahlten Zeitraum frei (24 Stunden oder 30 Tage ab Zahlung). Für weitere XML-Dateien kaufen Sie eine neue Freischaltung; falls Sie einen Fehler vermuten, schreiben Sie an support@arling.sk mit Ihrer Bestellnummer.',
  ...
  en: {
    ...
    zapina: 'Payment is still being switched on. Write to support@arling.sk and I will send you the XML by e-mail.',
    ...
    inaSuma: 'The payment arrived, but for a different amount. Write to support@arling.sk and we will sort it out by hand.',
    nepotvrdene: 'We could not confirm the payment yet. We keep trying; if you have paid, the download unlocks as soon as Stripe answers. If this takes longer than a few minutes, write to support@arling.sk with the order number from the Stripe e-mail.',
    overZnova: 'Check the payment again',
    siet: 'Checking the payment failed (network). Reload the page; if it keeps happening, write to support@arling.sk.',
    ...
    platnostSkoncila: (d) => 'The payment is confirmed, but its period ended on ' + d + '. The link unlocks the download only for the paid period (24 hours or 30 days from payment). For more XML files, buy a new unlock; if you think this is a mistake, write to support@arling.sk with your order number.',
...
function mailtoOdkaz() {
  return 'mailto:' + (LANG === 'sk' || LANG === 'cs' ? 'podpora' : 'support') + '@arling.sk?subject=' + encodeURIComponent(T.mailtoPredmet) + '&body=' + encodeURIComponent(T.mailtoTelo);
}
