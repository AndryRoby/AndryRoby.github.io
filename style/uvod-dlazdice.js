...
(function () {
  ...
  var FS = [
    ...
    ' float hd=length(c-uHover.xy);s+=uHover.z*.55*exp(-hd*hd/(2.*uCell*uCell*2.4));',
    ' return s;}',
    'void main(){',
    ...
    ' float a=tile*(uKlud+.14*zdvih)+hrana*(uKlud*1.4*hore+.16*zdvih*hore)+tile*spec*(.04+.34*zdvih);',
